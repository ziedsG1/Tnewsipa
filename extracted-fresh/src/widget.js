...
(async function init() {
  ...
  if (config.window?.width && config.window?.height) {
    document.documentElement.style.setProperty("--widget-w", `${config.window.width}px`);
    document.documentElement.style.setProperty("--widget-h", `${config.window.height}px`);
  }
