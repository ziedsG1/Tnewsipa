  ...
  const COUNTRIES = {
    ...
    sa: {
      ...
      feeds: [
        ...
        { id: "aawsat-en", label: "Asharq Al-Awsat", url: "https://english.aawsat.com/feed", locale: "en", priority: true, independent: true },
        { id: "aljazeera-ar", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "ar", priority: false, independent: true },
      ],
    ...
    ae: {
      ...
      feeds: [
        { id: "mee-ae", label: "Middle East Eye", url: "https://www.middleeasteye.net/rss.xml", locale: "en", priority: true, independent: true },
        { id: "arabnews-ae", label: "Arab News", url: "https://www.arabnews.com/rss.xml", locale: "en", priority: true, independent: false },
        { id: "aljazeera-ae", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "en", priority: false, independent: true },
      ],
    ...
    jo: {
      ...
      feeds: [
        ...
        { id: "aljazeera-jo", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "ar", priority: false, independent: true },
        { id: "mee-jo", label: "Middle East Eye", url: "https://www.middleeasteye.net/rss.xml", locale: "en", priority: false, independent: true },
      ],
    ...
    iq: {
      ...
      feeds: [
        { id: "rudaw", label: "Rudaw", url: "https://www.rudaw.net/rss", locale: "en", priority: true, independent: true },
        { id: "aljazeera-iq", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "ar", priority: false, independent: true },
        { id: "mee-iq", label: "Middle East Eye", url: "https://www.middleeasteye.net/rss.xml", locale: "en", priority: false, independent: true },
      ],
    ...
    ly: {
      ...
      feeds: [
        ...
        { id: "aljazeera-ly", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "ar", priority: false, independent: true },
        { id: "mee-ly", label: "Middle East Eye", url: "https://www.middleeasteye.net/rss.xml", locale: "en", priority: false, independent: true },
      ],
    ...
    us: {
      ...
      feeds: [
        ...
        { id: "bbc-us", label: "BBC US", url: "https://feeds.bbci.co.uk/news/world/us_and_canada/rss.xml", locale: "en", priority: true, independent: false },
    ...
    tr: {
      ...
      feeds: [
        ...
        { id: "bbc-tr-region", label: "BBC World", url: "https://feeds.bbci.co.uk/news/world/rss.xml", locale: "en", priority: false, independent: false },
        { id: "bbc-europe-tr", label: "BBC Europe", url: "https://feeds.bbci.co.uk/news/world/europe/rss.xml", locale: "en", priority: false, independent: false },
      ],
      ...
      feeds: [
        {
          id: "fars",
          label: "Fars News",
          url: "https://news.google.com/rss/search?q=site:farsnews.ir&hl=fa&gl=IR&ceid=IR:fa",
          altUrls: [
            "https://www.farsnews.ir/rss/allnews",
    ...
    sy: {
      ...
      feeds: [
        { id: "sana", label: "SANA", url: "https://sana.sy/en/?feed=rss2", locale: "en", priority: true, independent: false },
        { id: "aljazeera-sy", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "ar", priority: false, independent: true },
        { id: "mee-sy", label: "Middle East Eye", url: "https://www.middleeasteye.net/rss.xml", locale: "en", priority: false, independent: true },
      ],
      ...
      feeds: [
        {
          id: "gn-ye",
          label: "Yemen News",
          url: "https://news.google.com/rss/search?q=Yemen+when:7d&hl=en-US&gl=US&ceid=US:en",
          locale: "en",
          priority: true,
          independent: false,
        },
        { id: "aljazeera-ye", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "ar", priority: false, independent: true },
        { id: "bbc-me-ye", label: "BBC Middle East", url: "https://feeds.bbci.co.uk/news/world/middle_east/rss.xml", locale: "en", priority: false, independent: false },
      ],
    ...
    pk: {
      ...
      feeds: [
        ...
        { id: "bbc-asia", label: "BBC Asia", url: "https://feeds.bbci.co.uk/news/world/asia/rss.xml", locale: "en", priority: false, independent: false },
      ],
    ...
    in: {
      ...
      feeds: [
        ...
        { id: "bbc-india", label: "BBC Asia", url: "https://feeds.bbci.co.uk/news/world/asia/india/rss.xml", locale: "en", priority: false, independent: false },
      ],
    ...
    gb: {
      ...
      feeds: [
        ...
        { id: "bbc-uk-world", label: "BBC UK", url: "https://feeds.bbci.co.uk/news/uk/rss.xml", locale: "en", priority: false, independent: false },
      ],
    ...
    ca: {
      ...
      feeds: [
        ...
        { id: "bbc-americas", label: "BBC Americas", url: "https://feeds.bbci.co.uk/news/world/us_and_canada/rss.xml", locale: "en", priority: false, independent: false },
      ],
    ...
    sd: {
      ...
      feeds: [
        ...
        { id: "aljazeera-sd", label: "Al Jazeera", url: "https://www.aljazeera.com/xml/rss/all.xml", locale: "ar", priority: false, independent: true },
        { id: "mee-sd", label: "Middle East Eye", url: "https://www.middleeasteye.net/rss.xml", locale: "en", priority: false, independent: true },
      ],
    ...
    br: {
      ...
      feeds: [
        { id: "bbc-br", label: "BBC Brasil", url: "https://www.bbc.com/portuguese/index.xml", locale: "pt", priority: true, independent: false },
        { id: "guardian-br", label: "The Guardian", url: "https://www.theguardian.com/world/rss", locale: "en", priority: false, independent: true },
        { id: "bbc-latam", label: "BBC Latin America", url: "https://feeds.bbci.co.uk/news/world/latin_america/rss.xml", locale: "en", priority: false, independent: false },
      ],
