  ...
  const COUNTRIES = {
    ...
    ma: {
      ...
      feeds: [
        ...
        { id: "le360", label: "Le360", url: "https://www.le360.ma/rss", locale: "ar", priority: true, independent: false },
        { id: "map-ma", label: "MAP", url: "https://www.mapnews.ma/ar/feed", locale: "ar", priority: false, independent: false },
        { id: "alyaoum24", label: "Al Yaoum 24", url: "https://alyaoum24.com/feed", locale: "ar", priority: false, independent: false },
        { id: "telquel", label: "TelQuel", url: "https://telquel.ma/feed/", locale: "fr", priority: false, independent: true },
      ],
